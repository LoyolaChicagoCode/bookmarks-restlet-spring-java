...
public class ApplicationTest {
	...
	// use port 3000 for standalone
	//   (org.restlet.example.book.rest.ch7.springMain)
	// use port 8080 for embedded Jetty (mvn jetty:run)
    public static final String APPLICATION_URI = "http://localhost:3000/bookmarks-restlet-spring";
